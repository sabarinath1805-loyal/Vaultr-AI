...
import { generateTabularColumnPrompt } from "@/app/lib/vaultrApi";
            ...
            >
                <div className="min-h-0 flex-1 overflow-y-auto px-1 pb-5 pt-2">
                        ...
                        <ModalTextarea
                            ...
                            placeholder="Write the analysis prompt — describe what Vaultr should extract from each document for this column…"
