...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/vaultr-doc");
        const movingFolderId = e.dataTransfer.getData("application/vaultr-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/vaultr-doc") ||
            Array.from(e.dataTransfer.types).includes("application/vaultr-folder")
        );
    }
                    ...
                    return (
                        <li key={`f-${folder.id}`}>
                            <div
                                draggable
                                onDragStart={(e) => {
                                    e.dataTransfer.setData("application/vaultr-folder", folder.id);
                ...
                {childDocs.map((doc) => {
                    ...
                    return (
                        <li
                            ...
                            draggable
                            onDragStart={(e) => {
                                e.dataTransfer.setData("application/vaultr-doc", doc.id);
                                e.dataTransfer.effectAllowed = "move";
                            }}
