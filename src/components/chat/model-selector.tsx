      ...
      {open && (
        <>
          ...
          <div
            ...
            style={{ backgroundColor: '#111827', color: '#F5F0E8' }}
          >
            {!cloudMode && !isOllamaRunning ? (
              ...
              <>
                {!cloudMode && availableModels.map((modelId) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full rounded-[var(--radius-sm)] border-0 bg-transparent text-left transition-[background-color] duration-150 hover:bg-white/10"
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px" }}>
                        <span className="flex min-w-0 flex-1 flex-col">
                          ...
                          <span className="truncate" style={{ fontSize: "11px", color: "#8A8F9E" }}>
                            {metadata.modelId} · {metadata.provider}
                          </span>
                        </span>
                        {modelId === selectedModel && <Check size={14} style={{ color: '#C9A84C' }} />}
                      </div>
                    </button>
                  );
                })}
                {!cloudMode && availableModels.length > 0 && (
                  <div style={{ borderTop: "1px solid #2a2f3a", margin: "4px 0" }} />
                )}
                ...
                {!cloudMode && (
                <div style={{ borderTop: "1px solid #2a2f3a", marginTop: "4px", paddingTop: "4px" }}>
                  <div
                    onClick={() => {
                      setOpen(false);
                      router.push("/models");
